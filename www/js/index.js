...
newGameBtn.onclick = function () {
  ...
  document.getElementById("analog1").style.display = 'flex';
...
lvl2Btn.onclick = function () {
  ...
  document.getElementById("analog2").style.display = 'flex';
...
lvl3Btn.onclick = function () {
  ...
  document.getElementById("analog3").style.display = 'flex';
